...
import { UProSouthernNutrition } from '../../../../../../types/supplements/supplement';

type Props = {
  breakdowns: UProSouthernNutrition;
};

const UproSouthern: FC<Props> = ({ breakdowns }) => {
  return (
    <>
      <tr>
        <td className="p-1">
