...
import { UProForageNutrition } from '../../../../../../types/supplements/supplement';

type Props = {
  breakdowns: UProForageNutrition;
};

const UproForage: FC<Props> = ({ breakdowns }) => {
  return (
    <>
      <tr>
        <td className="p-1">
