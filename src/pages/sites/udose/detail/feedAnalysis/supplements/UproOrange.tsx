...
import { UProOrangeNutrition } from '../../../../../../types/supplements/supplement';

type Props = {
  breakdowns: UProOrangeNutrition;
};

const UproOrange: FC<Props> = ({ breakdowns }) => {
  return (
    <>
      <tr>
        <td className="p-1">
