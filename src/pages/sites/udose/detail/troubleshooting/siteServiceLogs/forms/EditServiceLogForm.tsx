...
const EditServiceLogForm: React.FC<Props> = ({
  register,
  errors,
  control,
  maintainersOptions,
      ...
      <Col md={12}>
        <div className="mb-2">
          <ReactSelect
            ...
            defaultSelected={maintainersOptions?.find(
              (item) => item.value === serviceLogDetail?.user_id
            )}
          />
        </div>
      </Col>
...
export default EditServiceLogForm;
