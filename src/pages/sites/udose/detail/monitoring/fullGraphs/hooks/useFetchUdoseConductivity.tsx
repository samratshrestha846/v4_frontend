...
export default function useFetchUdoseConductivity(id?: number) {
  ...
  const getUdoseconductivityBySiteId = () => {
    const filterParams: DurationQueryFilterParams | null =
      prepareFilterParams();
    return udoseSummary.getUdoseConductivityBySiteId(Number(id), filterParams);
  };

  const { data, isFetching, isFetched, isError } = useQuery({
    queryKey: ['udose-battery-solar-voltage-by-site-id', id, params],
    queryFn: getUdoseconductivityBySiteId,
