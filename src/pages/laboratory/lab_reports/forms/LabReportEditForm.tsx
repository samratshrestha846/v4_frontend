...
type Props = {
  ...
  handleIsPropertyExistChange: (e: ChangeEvent<HTMLInputElement>) => void;
};

const LabReportEditForm: React.FC<Props> = ({
  register,
  control,
  errors,
  showModal,
  ...
  return (
    <>
      <Row>
        ...
        <Col sm={6} md={6} className="react-select-form mb-3">
          <FormInput
            ...
            propagateOnChange={handleIsPropertyExistChange}
            defaultChecked={!!labReportDetail?.customer_property_id}
          />
        </Col>
          ...
          <Col sm={6} md={6} className="react-select-form mb-2">
            <ReactSelect
              ...
              defaultSelected={propertiesOptions?.find(
                (item) => item.value === labReportDetail?.customer_property_id
              )}
              isClearable
            />
          </Col>
      ...
      {defaultTestResults
        ...
        <Row>
          <Col>
            <h5 className="my-2 text-uppercase p-2 b-secondary">
      ...
      {selectedLabSamples && selectedLabSamples.length > 0 && (
        <Row>
          <Col md={12}>
            <h5 className="mt-0 my-2 text-uppercase p-2 b-secondary">
...
export default LabReportEditForm;
