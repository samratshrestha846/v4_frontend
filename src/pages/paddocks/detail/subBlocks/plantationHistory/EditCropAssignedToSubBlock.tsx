...
import useUpdateCropAssignedToSubBlock from './hooks/useUpdateCropAssignedToSubBlock';
...
const EditCropAssignedToSubBlock: React.FC<Props> = ({
  toggleModal,
  refetchSubBlocks,
  cropableDetail,
}) => {
  ...
  const {
    ...
    submitted,
  } = useUpdateCropAssignedToSubBlock({
    refetchSubBlocks,
    toggleModal,
    cropableDetail: cropable,
  });
...
export default EditCropAssignedToSubBlock;
