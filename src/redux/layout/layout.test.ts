...
describe('change left sidebar theme flow', () => {
  it('light', () => {
    return expectSaga(watchChangeLeftSidebarTheme)
      .withReducer(layoutReducer)
      .dispatch(
        actions.changeSidebarTheme(layoutConstants.LEFT_SIDEBAR_THEME_LIGHT)
      )
      .hasFinalState({
        ...INIT_STATE,
  ...
  it('dark', () => {
    return expectSaga(watchChangeLeftSidebarTheme)
      .withReducer(layoutReducer)
      .dispatch(
        actions.changeSidebarTheme(layoutConstants.LEFT_SIDEBAR_THEME_DARK)
      )
      .hasFinalState({
        ...INIT_STATE,
        leftSideBarTheme: layoutConstants.LEFT_SIDEBAR_THEME_DARK,
  ...
  it('default', () => {
    return expectSaga(watchChangeLeftSidebarTheme)
      .withReducer(layoutReducer)
      .dispatch(
        actions.changeSidebarTheme(layoutConstants.LEFT_SIDEBAR_THEME_DEFAULT)
      )
      .hasFinalState({
        ...INIT_STATE,
        leftSideBarTheme: layoutConstants.LEFT_SIDEBAR_THEME_DEFAULT,
...
describe('change left sidebar type flow', () => {
  it('condensed', () => {
    return expectSaga(watchChangeLeftSidebarType)
      .withReducer(layoutReducer)
      .dispatch(
        actions.changeSidebarType(layoutConstants.LEFT_SIDEBAR_TYPE_CONDENSED)
      )
      .hasFinalState({
        ...INIT_STATE,
  ...
  it('scrollable', () => {
    return expectSaga(watchChangeLeftSidebarType)
      .withReducer(layoutReducer)
      .dispatch(
        actions.changeSidebarType(layoutConstants.LEFT_SIDEBAR_TYPE_SCROLLABLE)
      )
      .hasFinalState({
        ...INIT_STATE,
        leftSideBarType: layoutConstants.LEFT_SIDEBAR_TYPE_SCROLLABLE,
  ...
  it('fixed', () => {
    return expectSaga(watchChangeLeftSidebarType)
      .withReducer(layoutReducer)
      .dispatch(
        actions.changeSidebarType(layoutConstants.LEFT_SIDEBAR_TYPE_FIXED)
      )
      .hasFinalState({
        ...INIT_STATE,
        leftSideBarType: layoutConstants.LEFT_SIDEBAR_TYPE_FIXED,
